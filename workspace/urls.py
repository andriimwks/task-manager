...
urlpatterns = [
    ...
    path(
        ...
        projects.UpdateProject.as_view(),
        name="update_project",
    ),
    path(
        "projects/<int:project_id>/delete",
        projects.DeleteProject.as_view(),
        name="delete_project",
    ),
    path(
        "projects/<int:project_id>/tasks/create",
        tasks.CreateTask.as_view(),
        name="create_task",
    ),
    ...
    path(
        ...
        partials.ProjectList.as_view(),
        name="partial_project_list",
    ),
    path(
        "partial/task-list/<int:project_id>",
        partials.TaskList.as_view(),
        name="partial_task_list",
    ),
]
